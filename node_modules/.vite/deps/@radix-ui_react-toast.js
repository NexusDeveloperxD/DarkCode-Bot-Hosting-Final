...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React19.useState(0);
  const isFocusedToastEscapeKeyDownRef = React19.useRef(false);
  const isClosePausedRef = React19.useRef(false);
  if (!label.trim()) {
    console.error(
  ...
  return (0, import_jsx_runtime11.jsx)(Collection.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime11.jsx)(
    ToastProviderProvider,
    {
      ...
      onToastAdd: React19.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React19.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React19.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const headFocusProxyRef = React19.useRef(null);
    const tailFocusProxyRef = React19.useRef(null);
    ...
    const getSortedTabbableCandidates = React19.useCallback(
      ({ tabbingDirection }) => {
...
var FocusProxy = React19.forwardRef(
  (props, forwardedRef) => {
...
var ToastImpl = React19.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React19.useRef(null);
    const swipeDeltaRef = React19.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React19.useRef(0);
    const closeTimerRemainingTimeRef = React19.useRef(duration);
    ...
    const startTimer = React19.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React19.useMemo(() => {
    ...
    return (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
      ...
      (0, import_jsx_runtime11.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM4.createPortal(
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React19.useState(false);
  const [isAnnounced, setIsAnnounced] = React19.useState(false);
...
var ToastAction = React19.forwardRef(
  (props, forwardedRef) => {
...
var ToastClose = React19.forwardRef(
  (props, forwardedRef) => {
